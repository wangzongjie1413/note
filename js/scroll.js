...
function qpgd(a) {
    ...
    if (-b == 0) {
        ...
        $('.num-5-float').slideUp(500);
        $('.num-1-float').slideUp(500);
    } else if (-b == 1) {
        ...
        $('.num-5-float').slideUp(500);
        $('.num-2-float').slideUp(500);
        setTimeout(function() { $('.num-1-float').slideDown(1000); }, 1100);
    } else if (-b == 2) {
        $('.num').eq(1).find('p').animate({ 'top': '0' }, 500);
        ...
        $('.num-1-float').slideUp(500);
        $('.num-3-float').slideUp(500);
        setTimeout(function() { $('.num-2-float').slideDown(1000); }, 1100);
    } else if (-b == 3) {
        $('.num').eq(2).find('p').animate({ 'top': '0' }, 500);
        ...
        $('.num-2-float').slideUp(500);
        $('.num-4-float').slideUp(500);
        setTimeout(function() { $('.num-3-float').slideDown(1000); }, 1100);
    } else if (-b == 4) {
        $('.num').eq(3).find('p').animate({ 'top': '0' }, 500);
        ...
        $('.num-3-float').slideUp(500);
        $('.num-5-float').slideUp(500);
        setTimeout(function() { $('.num-4-float').slideDown(1000); }, 1100);
    } else if (-b == 5) {
        $('.num').eq(4).find('p').animate({ 'top': '0' }, 500);
        setTimeout(function() {
        ...
        $('.num-4-float').slideUp(500);
        $('.num-1-float').slideUp(500);
        setTimeout(function() { $('.num-5-float').slideDown(1000); }, 1100);
    }
